...
import { SKILLSET_GROUPS, EDUCATION_DATA, TECH_LOGOS } from "../../../lib/data/portfolio-data";
import { containerVariants, cardVariants, avatarVariants } from "../../../lib/animations/variants";
import { getRelativeTime } from "../../../lib/utils/portfolio-helpers";
import { GithubIcon, LinkedinIcon, TwitterIcon, UserIcon } from "../icons/SocialIcons";
import AppearingTextAnimation from "../AppearingTextAnimation";
...
interface HomeTabProps {
  effectivelyAnimated: boolean;
  mounted: boolean;
}

const HomeTab: React.FC<HomeTabProps> = ({ effectivelyAnimated: _effectivelyAnimated, mounted }) => {
  return (
    <motion.div
    ...
    >
      {/* Hero Section */}
      <section className="sticky top-0 h-screen w-full flex flex-col justify-center px-4 bg-gray-100 dark:bg-gray-950 z-[1] shrink-0 overflow-hidden">
        {mounted && <MatrixRain startDelayMs={3200} />}
