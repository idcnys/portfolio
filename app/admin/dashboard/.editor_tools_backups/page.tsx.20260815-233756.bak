...
const Dashboard: React.FC<DashboardProps> = ({ onLogout }) => {
  ...
  const tabs = [
    ...
    {
      id: "manage-experience" as DashboardTab,
  ...
  const saveExperienceItem = async () => {
    ...
    if (
      ...
      setMessage({
        text: "Period, role, and company are required.",
        type: "error",
      });
      setTimeout(() => setMessage({ text: "", type: "" }), 3000);
      return;
    ...
    if (nextExperiences.length > 0 && !nextExperiences.some((item) => item.latest)) {
      nextExperiences = [
  ...
  const deleteExperienceItem = async (id: string) => {
    ...
    if (!window.confirm(`Delete experience: ${target.role} at ${target.company}?`)) {
      return;
    }
            ...
            <div className="xl:col-span-2 bg-white rounded-3xl border border-gray-100 p-6 space-y-4 shadow-sm dark:bg-gray-900 dark:border-gray-800">
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  onChange={(event) => setExperienceStackInput(event.target.value)}
                  className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 outline-none focus:bg-white focus:border-[#FFDB14] text-sm text-gray-900 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-100"
                />
                <input
                  type="text"
              ...
              <button
                type="button"
                onClick={saveExperienceItem}
                className="w-full bg-[#FFDB14] text-gray-900 px-4 py-3 rounded-xl text-xs font-black abcdefgh abcdefghijwider hover:bg-yellow-400 transition-all shadow-sm"
              >
            ...
            <div className="xl:col-span-3 bg-white rounded-3xl border border-gray-100 p-6 shadow-sm dark:bg-gray-900 dark:border-gray-800">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-bold text-gray-500 dark:text-gray-400">
                  {(portfolioSettings?.experiences || []).length} items
                </span>
              </div>
              ...
              <div className="space-y-3 max-h-[70vh] overflow-y-auto pr-1">
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <p className="text-[11px] font-bold abcdefgh abcdefghijwider text-gray-500 dark:text-gray-400">
                            {item.period}
                          </p>
                        ...
                        {item.latest && (
                          <span className="px-2 py-1 rounded-full text-[10px] font-black abcdefgh abcdefghijwider bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900">
                            Latest
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        ...
                        <button
                          type="button"
                          onClick={() => markExperienceAsLatest(item.id)}
                          className="px-3 py-1.5 rounded-lg text-xs font-bold border border-gray-200 text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
                        >
                          Mark Latest
                        </button>
                ...
                {(portfolioSettings?.experiences || []).length === 0 && (
                  <div className="p-12 text-center text-gray-400 font-bold abcdefgh abcdefghijwidest bg-gray-50 rounded-2xl border border-dashed border-gray-200 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-500">
                    <Ghost className="w-10 h-10 mb-4 opacity-20 mx-auto" />
