              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-6 py-4 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-2xl outline-none focus:bg-white dark:focus:bg-gray-800 focus:border-[#FFDB14] transition-all font-black text-gray-900 dark:text-white"
                      value={formData.date}
                      onChange={(e) =>
                ...
                <div>
                  ...
                  <small className="text-gray-500 text-xs mt-2 block">
                    Separate tags with commas. Example: React, TypeScript,
                    Node.js
                  </small>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-2xl px-4 py-2 focus-within:border-[#FFDB14]">
                  ...
                  <div className="flex items-center justify-between mb-4 px-2">
                    ...
                    <div className="flex gap-2 p-1 bg-gray-50 rounded-xl border border-gray-100">
                      <button
                        ...
                        className="w-9 h-9 hover:bg-white dark:hover:bg-gray-700 rounded-lg text-xs font-black shadow-sm text-gray-700 dark:text-gray-300"
                        title="Subheading"
                      >
                        H
                      </button>
                      ...
                      <button
                        ...
                        className="w-9 h-9 hover:bg-white dark:hover:bg-gray-700 rounded-lg text-xs shadow-sm text-gray-700 dark:text-gray-300"
                        title="Link"
                      >
